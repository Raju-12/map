...
Geocode.setApiKey("AIzaSyB3y5sYWjpDS3iapAKLvpUnlN0My_D5X_U");
Geocode.enableDebug();
    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 1000 }}>
                ...
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyB3y5sYWjpDS3iapAKLvpUnlN0My_D5X_U&libraries=places"
                    loadingElement={
